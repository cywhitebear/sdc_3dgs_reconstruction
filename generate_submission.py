...
def main():
    # --- PATH CONFIGURATION ---
    PLY_FILE = "/media/ee904/DATA1/ITRI_58/2025-03-10-10-48-26-b58-lidar-camera-ptp/3dgs_project/output_v2/gaussian_reconstruction_v2.ply"
    K_JSON = "/media/ee904/DATA1/ITRI_58/2025-03-10-10-48-26-b58-lidar-camera-ptp/itri58_colored_pcd/camera_intrinsics.json"
    POSE_LIST_FILE = "test_pose_list.txt" # Generated from camera_gt_pose.txt[cite: 5]
    FRAME_LIST_FILE = "test_frame_list.txt" # Official contest frame IDs[cite: 4]
