...
def load_and_interpolate():
    # --- PATHS ---
    IMG_DIR = "/media/ee904/DATA1/ITRI_58/2025-03-10-10-48-26-b58-lidar-camera-ptp/itri58_colored_pcd/itri58_image"
    GT_POSE_FILE = "/media/ee904/DATA1/ITRI_58/2025-03-10-10-48-26-b58-lidar-camera-ptp/itri58_colored_pcd/camera_gt_pose.txt"
    TEST_LIST_FILE = "test_frame_list.txt"
    OUTPUT_FILE = "test_pose_list.txt"
